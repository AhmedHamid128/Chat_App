...
class group_member_edit_delet extends StatefulWidget {
  final List<String> memberIds; // Changed to receive member IDs
  final String groupId;

  group_member_edit_delet(
      {super.key, required this.memberIds, required this.groupId});
...
class _group_member_edit_deletState extends State<group_member_edit_delet> {
  ...
  void _toggleAdmin(String memberId) {
    // Implement admin promotion/demotion logic
  }
}
*/
